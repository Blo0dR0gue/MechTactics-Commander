...
const planetTable = new Table<(typeof planets)[number]>(
  ...
  [
    ...
    { name: 'Text', dataAttribute: 'planetText', size: 'col-4' },
    {
      name: 'Action',
      size: 'col-1',
      buttons: [
        {
          icon: createSVGElementFromString(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
